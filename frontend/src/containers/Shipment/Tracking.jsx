...
const ShipmentTracker = () => {
  ...
  return (
    <div className="bg-body-color w-full min-h-screen flex flex-col px-2 py-4 lg:px-6 lg:py-4 mt-16">
      ...
      {/* Main Content */}
      <div className="flex flex-col lg:flex-row lg:space-x-6 mt-4 space-y-6 lg:space-y-0">
        {/* Left Column */}
        <div className="flex flex-col space-y-6 w-full lg:w-1/2">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex items-center space-x-4">
              <img src={Truck} alt="truck" className="hidden md:block mt-[-18vh]" />
              <div>
                <h3 className="font-semibold">Freightliner Cascadia</h3>
                <p className="text-sm text-gray-500 mb-4">Truck - 4F299LX2</p>
                <div className="mt-2 ml-[-3.5vw] space-y-2">
                  {/* In Transit */}
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex justify-between w-full lg:w-[30vw]">
                      <div className="grid font-normal text-sm text-black ml-4">
        ...
        <div className="w-full lg:w-1/2 bg-white px-6 rounded-lg shadow-md relative">
          <h2 className="text-lg font-medium mb-4 bg-[#f5f5f5] mx-[-24px] px-4 pt-2 pb-2">
            Map Overview
          </h2>
          <div className="relative top-0 left-0 right-0 bottom-0 w-full bg-gray-200 rounded-lg">
